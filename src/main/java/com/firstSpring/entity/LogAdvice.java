...
public class  LogAdvice {
    ...
    @AfterThrowing(value = "@annotation(com.firstSpring.entity.LogException)",throwing = "exception")
    ...
    @AfterReturning(value = "@annotation(com.firstSpring.entity.LogException)",returning = "result")
